      ...
      <div className="max-w-6xl mx-auto px-4 py-16">
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="col-span-2">
            ...
            <p className="text-gray-400 mb-6 leading-relaxed max-w-md">
              Empowering developers with cutting-edge tutorials, insights, and best practices.
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/blog" className="text-gray-400 hover:text-white transition-colors hover:translate-x-1 inline-block">
                  All Articles
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/admin" className="text-gray-400 hover:text-white transition-colors hover:translate-x-1 inline-block">
                  Write Post
                </Link>
              </li>
              <li>
                <Link href="#newsletter" className="text-gray-400 hover:text-white transition-colors hover:translate-x-1 inline-block">
                  Newsletter
                </Link>
              </li>
            </ul>
          ...
          {/* Categories */}
          <div>
            <h4 className="font-bold text-lg mb-6">Popular Topics</h4>
            <ul className="space-y-3">
              <li>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            &copy; {currentYear} TechBlog. All rights reserved. Built with ❤️ and Next.js
          </p>
